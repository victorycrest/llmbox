...
dialog_api = ui.dialog(
    ...
    items=[
        ...
        ui.text('''<center>
            Set the environment variable ANTHROPIC_API_KEY with your 
            <a href="https://console.anthropic.com/account/keys" target="_blank">API key</a> 
            & restart the app''')
    ],
    blocking=True,
    events=['dismissed']
